...
export default function LoginPage() {
  ...
  const canSubmit = email.trim() !== '' && password.trim() !== '' && confirmPassword.trim() !== '' && password === confirmPassword;
  ...
  return (
    <section className="container px-7 p-lg-10">
      <div className='d-lg-flex gap-10'>
        ...
        <div className="register">
          <h1 className="mb-4 fs-3 text-black">歡迎加入 ZOBAA</h1>
          ...
          <form onSubmit={handleSubmit} className="d-grid gap-3">
            <div className="fw-bold mb-2 text-black">或使用 ZOBAA 帳號註冊</div>
            <div>
            ...
            <div>
              <label className="text-neutral-80 mb-2">確認密碼 <span className="text-alert">*</span></label>
              <input
                type="password"
                className="form-control text-neutral-60 rounded-6 p-5"
              ...
              {confirmPassword && confirmPassword !== password && (
                <div className="form-text text-danger mt-1">兩次密碼不一致</div>
              )}
            </div>
            ...
            <p className="text-neutral-80 fs-body2 mt-5">
              建立帳號即表示您同意我們的
              <a className="link-neutral-80 mx-1" href="#" style={{ textDecoration: 'underline' }}>服務條款</a>
              及
              <a className="link-neutral-80 mx-1" href="#" style={{ textDecoration: 'underline' }}>隱私權政策</a>
            </p>
          </form>


          <p className="text-neutral-80 fs-body1">
            已經有 ZOBAA 帳號了嗎？ <a className="link-primary-100 fw-bold" href="/login" style={{ textDecoration: 'underline' }}>立即登入</a>
          </p>
